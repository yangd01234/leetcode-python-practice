...
What are the bitwise operators and what do they do?
What does the bitwise right shift do?
What does the bitwise left shift do?
Where should you start for shifting?
Why do you need to decrease the power after shifting?
Why does length of 32 matter?
"""

class Solution:
    def reverseBits(self, n: int) -> int:

        # indicate the result and the power to index.  31 for 32 bit
        res, power = 0, 31

        while n:
            # you use the and operator for a bitwise and.  Then leftshift by the power
            res += (n&1) << power
